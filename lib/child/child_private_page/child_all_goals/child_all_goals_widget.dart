...
import 'child_all_goals_model.dart';
export 'child_all_goals_model.dart';

class ChildAllGoalsWidget extends StatefulWidget {
  const ChildAllGoalsWidget({Key? key}) : super(key: key);

  @override
  _ChildAllGoalsWidgetState createState() => _ChildAllGoalsWidgetState();
}

class _ChildAllGoalsWidgetState extends State<ChildAllGoalsWidget>
    with TickerProviderStateMixin {
  late ChildAllGoalsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChildAllGoalsModel());
                                ...
                                children: [
                                      ...
                                      child: FutureBuilder<List<GoalsRow>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return ListView.separated(
                                            ...
                                            itemCount:
                                                listViewGoalsRowList.length,
                                            separatorBuilder: (_, __) =>
                                                SizedBox(height: 16.0),
                                            itemBuilder:
                                                (context, listViewIndex) {
                                              final listViewGoalsRow =
                                                  listViewGoalsRowList[
                                                      listViewIndex];
                                              return Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          'By ${valueOrDefault<String>(
                                                                            listViewGoalsRow.dueDay?.toString(),
                                                                            '22 th Aug',
                                                                          )}',
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed('Child_CreateGoals');
                                      },
                                      text: '+ Add new goal',
